...
namespace ChatServidor
{
    ...
    class ChatServidor
    {
        ...
        public static void EnviaMensagemAdmin(string Mensagem)
        {
            ...
            e = new StatusChangedEventArgs("[" + DateTime.Now.ToString("HH:mm:ss") + "] " + "SISTEMA: " + Mensagem);
            OnStatusChanged(e);
            ...
            for (int i = 0; i < tcpClientes.Length; i++)
            {
                ...
                try
                {
                    ...
                    swSenderSender.WriteLine("[" + DateTime.Now.ToString("HH:mm:ss") + "] " + "SISTEMA: " + Mensagem);
        ...
        public static void EnviaMensagem(string Origem, string Mensagem)
        {
            ...
            e = new StatusChangedEventArgs("[" + DateTime.Now.ToString("HH:mm:ss") + "] " + Origem + " disse: " + Mensagem);
            OnStatusChanged(e);
            ...
            for (int i = 0; i < tcpClientes.Length; i++)
            {
                ...
                try
                {
                    ...
                    // Envia a mensagem para o usuário atual no laço
                    swSenderSender = new StreamWriter(tcpClientes[i].GetStream());
                    swSenderSender.WriteLine("[" + DateTime.Now.ToString("HH:mm:ss") + "] " + Origem + " disse: " + Mensagem);
                    swSenderSender.Flush();
                    swSenderSender = null;
                }
                catch // Se houver um problema , o usuário não existe , então remove-o
        ...
        public void IniciaAtendimento()
        {
            ...
            {    
                ...
                tlsCliente = new TcpListener(ipaLocal, port);
