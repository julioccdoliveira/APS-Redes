    ...
    public partial class frmCliente : Form
    {
        ...
        private void btnConectar_Click(object sender, System.EventArgs e)
        {
            ...
            if (Conectado == false)
            {
                ...
                if (string.IsNullOrEmpty(txtUsuario.Text))
                {
                    ...
                    txtUsuario.Text = "Convidado" + numero.Next(1, 1000);
                }
                InicializaConexao();
            }
        ...
        private void InicializaConexao()
        {
            try
            {
                ...
                tcpServidor.Connect(enderecoIP, int.Parse(txtPorta.Text));
        ...
        private void EnviaMensagem()
        {
            if (txtMensagem.Lines.Length >= 1)
            {
                ...
                {
                    FechaConexao("Desconectado. Comando /quit executado. mIRC feelings.");
                }
